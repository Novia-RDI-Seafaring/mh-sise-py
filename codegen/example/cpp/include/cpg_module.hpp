...
struct CPG_Prim_cpp_t {
    std::array<double, 1500> W;
    std::array<double, 200> V;
    std::array<double, 198> U;
    std::array<double, 1500> X;
};

// Dual solution
struct CPG_Dual_cpp_t {
    std::array<double, 15> d0;
    std::array<double, 1485> d1;
