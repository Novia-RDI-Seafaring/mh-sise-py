...
"""
Auto-generated by CVXPYgen on September 11, 2024 at 21:02:10.
...
def cpg_solve(prob, updated_params=None, **kwargs):
    ...
    prob.var_dict['W'].save_value(np.array(res.cpg_prim.W).reshape((15, 100), order='F'))
    ...
    prob.var_dict['X'].save_value(np.array(res.cpg_prim.X).reshape((15, 100), order='F'))
    prob.constraints[0].save_dual_value(np.array(res.cpg_dual.d0).reshape(15))
    prob.constraints[1].save_dual_value(np.array(res.cpg_dual.d1).reshape((15, 99), order='F'))
