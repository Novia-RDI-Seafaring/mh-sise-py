...
void cpg_update_Q_w_sqrt(cpg_int idx, cpg_float val){
  cpg_params_vec[idx+0] = val;
  Canon_Outdated.A = 1;
}

void cpg_update_Q_v_sqrt(cpg_int idx, cpg_float val){
  cpg_params_vec[idx+9] = val;
  Canon_Outdated.A = 1;
}

void cpg_update_Q_u_sqrt(cpg_int idx, cpg_float val){
