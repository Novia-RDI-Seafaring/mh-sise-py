...
int main(int argc, char *argv[]){
  ...
  cpg_update_Q_w_sqrt(0, 10.00000000000000000000);
  cpg_update_Q_v_sqrt(0, 10.00000000000000000000);
  cpg_update_Q_u_sqrt(0, 1.00000000000000000000);
  cpg_update_x0(0, 0.00000000000000000000);
  cpg_update_A(0, -0.00000000001233969416);
  cpg_update_B(0, 10.00004786590369221244);
  cpg_update_y(0, 0.16990578049384605364);
  ...
  for(i=0; i<200; i++) {
    printf("vvar[%d] = %f\n", i, CPG_Result.prim->vvar[i]);
  }
  for(i=0; i<198; i++) {
    printf("uvar[%d] = %f\n", i, CPG_Result.prim->uvar[i]);
  }
  for(i=0; i<300; i++) {
    printf("xvar[%d] = %f\n", i, CPG_Result.prim->xvar[i]);
  }
