...
extern void cpg_update_Q_w_sqrt(cpg_int idx, cpg_float val);
extern void cpg_update_Q_v_sqrt(cpg_int idx, cpg_float val);
extern void cpg_update_Q_u_sqrt(cpg_int idx, cpg_float val);
