...
struct CPG_Params_cpp_t {
    std::array<double, 9> Q_w_sqrt;
    std::array<double, 4> Q_v_sqrt;
    std::array<double, 4> Q_u_sqrt;
...
struct CPG_Prim_cpp_t {
    std::array<double, 200> vvar;
    std::array<double, 198> uvar;
    std::array<double, 300> xvar;
};
