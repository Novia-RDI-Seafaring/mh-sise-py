...
"""
Auto-generated by CVXPYgen on September 11, 2024 at 20:44:13.
...
from codegen.sise_test import cpg_module
...
def cpg_solve(prob, updated_params=None, **kwargs):
    ...
    if updated_params is None:
        updated_params = ["Q_w_sqrt", "Q_v_sqrt", "Q_u_sqrt", "x0", "A", "B", "y", "C"]
    ...
    par.Q_w_sqrt = list(param_dict["Q_w_sqrt"].value.flatten(order="F"))
    par.Q_v_sqrt = list(param_dict["Q_v_sqrt"].value.flatten(order="F"))
    par.Q_u_sqrt = list(param_dict["Q_u_sqrt"].value.flatten(order="F"))
    ...
    prob.var_dict['vvar'].save_value(np.array(res.cpg_prim.vvar).reshape((2, 100), order='F'))
    prob.var_dict['uvar'].save_value(np.array(res.cpg_prim.uvar).reshape((2, 99), order='F'))
    prob.var_dict['xvar'].save_value(np.array(res.cpg_prim.xvar).reshape((3, 100), order='F'))
